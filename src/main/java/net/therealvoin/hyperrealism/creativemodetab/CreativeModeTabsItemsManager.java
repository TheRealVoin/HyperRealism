...
public class CreativeModeTabsItemsManager {
    ...
    public static void manageModdedItemsInTabs(BuildCreativeModeTabContentsEvent event) {
        ...
        /* I know that this code is awful and needs refactoring,
           but it works
         */
        ...
        } else if (currentTab == CreativeModeTabs.COMBAT) {
        ...
        } else if (currentTab == CreativeModeTabs.SPAWN_EGGS) {
        ...
        if (currentTab == net.therealvoin.hyperrealism.creativemodetab.CreativeModeTabs.BURNT_BASIC_TAB.getKey()) {
